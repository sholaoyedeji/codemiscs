...
# The --info option
function cl_option_info
{
	cl_mode="info"
}

# The --warning option
function cl_option_warning
{
	cl_mode="warning"
}

# The --error option
function cl_option_error
{
	cl_mode="error"
}
